...
export default function TermsOfServiceScreen() {
  ...
  const sections = [
    ...
    { title: t('legal.tosAccounts'), body: t('legal.tosAccountsBody') },
    { title: t('legal.tosAcceptableUse'), body: t('legal.tosAcceptableUseBody') },
    { title: t('legal.tosPayments'), body: t('legal.tosPaymentsBody') },
    { title: t('legal.tosIntellectualProperty'), body: t('legal.tosIntellectualPropertyBody') },
    { title: t('legal.tosTermination'), body: t('legal.tosTerminationBody') },
